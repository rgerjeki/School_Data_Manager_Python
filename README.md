...
- Run the generateKey.py file by typing "python generateKey.py" or "python3 generateKey.py" in the terminal and pressing Enter.
- The script will generate a secret key and save it to a file named "mykey.key".
- Copy the generated secret key.
- Create a .env file in the project directory and add the following line: export SECRET_KEY=<enter key here>, replacing <enter key here> with the secret key you copied.
- Save the .env file and run the command "source .env" in the terminal to export the secret key as an environment variable. (make sure you're in the project's directory)
## Running the project

Once you have generated the secret key and exported it as an environment variable, you can run the project by following these steps:

- In the terminal, navigate to the project directory.
- Run the main.py file by typing "python main.py" or "python3 main.py" in the terminal and pressing Enter.
The project should now be running and you can use it as intended.

## Code

#### generateKey.py
This script generates a key using the Fernet library from the cryptography package. The key can be used to encrypt and decrypt data, such as sensitive information or files.
...
with open('mykey.key', 'wb') as mykey:
    mykey.write(key)
```
This code generates a key using the Fernet library and saves it to a file called mykey.key. You can modify the filename to save the key to a different location or with a different name.
...
[@rgerjeki](https://www.github.com/rgerjeki)
